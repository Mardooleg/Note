...
//
//public class StateAdapter_check extends RecyclerView.Adapter<StateAdapter_check.ViewHolder> implements GestureDetector.OnGestureListener  {
//
...
//        }
//
//        StateAdapter_check(Context context, List<Notatka> notatkas, boolean passcode) {
...
//        @NonNull
//        @Override
//        public StateAdapter_check.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
//
//            View view = inflater.inflate(R.layout.item_note_list, parent, false);
//            return new StateAdapter_check.ViewHolder(view);
//
//        }
//
//        @Override
//        public void onBindViewHolder(StateAdapter_check.ViewHolder holder, int position) {
